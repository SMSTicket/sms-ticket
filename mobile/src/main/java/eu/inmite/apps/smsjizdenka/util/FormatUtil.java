...
public class FormatUtil {
    ...
    public static String formatDate3339(String s3339) {
        return formatDateTime(timeFrom3339(s3339));
    }

    public static String formatDate(Time time) {
        return formatDate(time.toMillis(false));
    }
    ...
    public static String formatTime(Time time) {
        return formatTime(time.toMillis(false));
    }
    ...
    public static String formatDateTime(Time time) {
        return formatDateTime(time.toMillis(false));
    }
    ...
    public static String formatDateTimeDifference(Time time) {
        return formatDateTimeDifference(time.toMillis(false));
    }
