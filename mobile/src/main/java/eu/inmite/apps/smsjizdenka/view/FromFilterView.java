...
public class FromFilterView extends BaseFilterView {
    ...
    public FromFilterView(Context context, AttributeSet attrs) {
        super(context, attrs);
        c = context;
        init();
    }
    ...
    public FromFilterView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void update() {
        if (mSelected == FILTER_ALL) {
            ...
            vSelected.setText(c.getString(R.string.stats_from_date, FormatUtil.formatDate(mSelected)));
        }
    }
