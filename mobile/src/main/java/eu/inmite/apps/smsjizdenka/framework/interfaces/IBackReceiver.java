...
package eu.inmite.apps.smsjizdenka.framework.interfaces;

/**
 * Allow to handle back button in fragments.
 *
...
public interface IBackReceiver {
     ...
     * @return return true if you processed the back button and don't want the activity to handle it
     */
    boolean onBackPressed(boolean fromActionBar);
